...
positions become vacant during or before the first month of a term, a
by-election shall be held for those seats. If no by-election is held by the
start of that term, one shall be held as soon as possible after the term begins.

== Elected Executive & Upper-Year Reps
...
general elections shall be held in each term for the subsequent term. Elections
shall be conducted using a preferential ballot system.

== Appointed Executives
The following executives shall be appointed for each term by the Board of
Directors in the previous term:
+ the Vice-President, Finance;
+ the Vice-President, Internal;
+ the Vice-President, Communications; and,
+ the Vice-President, Operations.

== Election to Multiple Positions
