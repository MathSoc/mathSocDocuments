...
Council. If two or more seats are open after the General Election in any given constituency all but one seat will be added to the At Large allocation for that term. For greater certainty, no At Large Representative is elected during the General Election. 
