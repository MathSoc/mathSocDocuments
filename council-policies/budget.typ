...
\begin{enumerate}
    \item MathSoc Executives and Clubs may apply or seek funding/sponsorship from external sources to help pay for Capital Improvements, projects, or events for the Society or for a Club. All Capital Asset purchases in excess of \$3,000 must first be approved by Council prior to applying for funding from an external source, e.g. MEF or SLEF.
